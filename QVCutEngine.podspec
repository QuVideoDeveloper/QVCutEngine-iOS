#
# Be sure to run `pod lib lint QVCutEngine.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'QVCutEngine'
  s.version          = '1.0.4'
  s.summary          = 'A short description of QVCutEngine.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/QuVideoDeveloper/QVCutEngine-iOS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sunshine' => 'cheng.xia@quvideo.com' }
  s.source           = { :git => 'https://github.com/QuVideoDeveloper/QVCutEngine-iOS.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'QVCutEngine' => ['QVCutEngine/Assets/*.png']
  # }
