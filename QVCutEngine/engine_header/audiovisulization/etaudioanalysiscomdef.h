...
#define MDT_TEMPO_SET                   (MATH_DATE_TYPE_BASE + 0x00060000)//0x00060000, 数据是ASP模块输出的ASP_TEMPO_DETECTION_RESULT
...
#define IS_COMBO_MDT(mdt)	\
		(MDT_SPECTRUM==(mdt) || MDT_VOLUMN_SET==(mdt) || MDT_ONSET_SET==(mdt) || MDT_FLOAT_GROUP==(mdt) || MDT_TEMPO_SET==(mdt))
