...
#define MERR_CAM_CAPTURE_MODE				(MERR_CAM_BASE+10)
...
#define MERR_TEXT_BASE                  	0x7000
#define MERR_CAPU_BASE						0x00050000	//added by Jonathan to manager all error of common and platformutilss
#define MERR_QASP_BASE						0x00060000  //added by Jonathan to manager all errors of audio signal processing module
#define MERR_QGCS_BASE						0x00070000	//added by Jonathan to manager all errors of graphic coordinate characterization module
#define MERR_QGRAPHIC_BASE					0x00080000	//added by Jonathan to manager all errors of graphic process module
#define MERR_MEDIA_BASE						0x00500000	//added by Jonathan to manager all errors precisely for mediabase module
...
/*
 * error define for common and platform utils
 */
#define MERR_IOS_CRYPTO_BASE					(MERR_CAPU_BASE)	//0x00050000, qvcrypto.mm
#define MERR_ANDROID_JNI_CRYPTO_BASE			(MERR_CAPU_BASE+0x00000100)	//0x00050100,
#define MERR_WIN32_CRYPTO_BASE					(MERR_CAPU_BASE+0x00000200)	//0x00050200,
#define MERR_CRYPTO_ADAPTOR_BASE				(MERR_CAPU_BASE+0x00000300)	//0x00050300,
#define MERR_MONITOR_BASE						(MERR_CAPU_BASE+0x00000400)	//0x00050400, qvmonitor.cpp
#define MERR_MONITOR_JNI_BASE					(MERR_CAPU_BASE+0x00000500)	//0x00050500, jni_qmonitor.cpp
#define MERR_CONTENT_JNI_BASE					(MERR_CAPU_BASE+0x00000600)	//0x00050600, jni_mstreamcontent.cpp


#define MERR_JNI_BASE					0x00600000
#define	MERR_JNI_AMAUD_BASE		(MERR_JNI_BASE + 0x1000)
#define	MERR_JNI_AMCAM_BASE		(MERR_JNI_BASE + 0x2000)
#define	MERR_JNI_AMDISP_BASE		(MERR_JNI_BASE + 0x3000)
#define	MERR_JNI_AMTHR_BASE		(MERR_JNI_BASE + 0x4000)
#define	MERR_JNI_AMTMR_BASE		(MERR_JNI_BASE + 0x5000)
#define	MERR_JNI_IMUT_BASE		(MERR_JNI_BASE + 0x6000)
#define	MERR_JNI_JIMUT_BASE		(MERR_JNI_BASE + 0x7000)
#define	MERR_JNI_JAMAUD_BASE		(MERR_JNI_BASE + 0x8000)
#define	MERR_JNI_JAMDISP_BASE		(MERR_JNI_BASE + 0x9000)
#define	MERR_JNI_JBASED_BASE		(MERR_JNI_BASE + 0xa000)
#define	MERR_JNI_JBITMAPUT_BASE		(MERR_JNI_BASE + 0xb000)
#define	MERR_JNI_JHELPER_BASE		(MERR_JNI_BASE + 0xc000)
#define	MERR_JNI_JSTR_BASE		(MERR_JNI_BASE + 0xd000)
#define	MERR_JNI_JSTRAS_BASE		(MERR_JNI_BASE + 0xe000)
#define	MERR_JNI_JMTHR_BASE		(MERR_JNI_BASE + 0xf000)
#define	MERR_JNI_JMTMR_BASE		(MERR_JNI_BASE + 0x10000)
#define	MERR_JNI_JOGL_BASE		(MERR_JNI_BASE + 0x11000)
#define	MERR_JNI_JSECUT_BASE		(MERR_JNI_BASE + 0x12000)
#define	MERR_JNI_JTXT_BASE		(MERR_JNI_BASE + 0x13000)
#define	MERR_JNI_MPM_BASE		(MERR_JNI_BASE + 0x14000)
#define	MERR_JNI_ONLD_BASE		(MERR_JNI_BASE + 0x15000)
#define	MERR_JNI_CRYPTO_BASE		(MERR_JNI_BASE + 0x16000)
#define	MERR_JNI_PLTUT_BASE		(MERR_JNI_BASE + 0x17000)

#define MERR_IOS_BASE					0x00680000
#define	MERR_IOS_AMAUD_BASE		(MERR_IOS_BASE + 0x1000)
#define	MERR_IOS_AMDISP_BASE		(MERR_IOS_BASE + 0x2000)
#define	MERR_IOS_AMTMR_BASE		(MERR_IOS_BASE + 0x3000)
#define	MERR_IOS_AVFUT_BASE		(MERR_IOS_BASE + 0x4000)
#define	MERR_IOS_IMGUT_BASE		(MERR_IOS_BASE + 0x5000)
#define	MERR_IOS_MPM_BASE		(MERR_IOS_BASE + 0x6000)
#define	MERR_IOS_MTIP_BASE		(MERR_IOS_BASE + 0x7000)
#define	MERR_IOS_FRAME_BASE		(MERR_IOS_BASE + 0x8000)
#define	MERR_IOS_TEXTC_BASE		(MERR_IOS_BASE + 0x9000)
#define	MERR_IOS_TEXTUT_BASE		(MERR_IOS_BASE + 0xa000)
#define	MERR_IOS_UTIL_BASE		(MERR_IOS_BASE + 0xb000)
#define MERR_IOS_MONITOR        (MERR_IOS_BASE + 0xC000) 
