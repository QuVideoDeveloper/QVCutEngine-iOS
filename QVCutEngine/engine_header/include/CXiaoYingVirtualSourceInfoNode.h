...
@end
 ...
 @interface CXiaoYingVirtualSourceInfoNode : NSObject
 {
     ...
     QVET_FRAME_VECTOR_3 _Rotation;
	 //MBool  _bApplyPanzoom;//场景虚拟节点对应是否应用panzoom的状态， true 应用，false 不应用
	 MDWord _dwPanzoomMode; //0没有panzoom,1 blur,2 color fill,3 transparent
 ...
 @property(readwrite, nonatomic) QVET_FRAME_VECTOR_3 Rotation;
 @property(readwrite,nonatomic) MDWord dwPanzoomMode;
