...
#define MVLIB_ERR_MEDIA_INVERSE_BASE (MVLIB_ERR_BASE + 0x55000)
#define MVLIB_ERR_JPEG_DECODE_BASE  (MVLIB_ERR_BASE + 0x56000)
#define MVLIB_MEDIA_INVERSE_DEC_VIDEO_THREAD_IOS_BASE    (MVLIB_ERR_BASE + 0x57000)
#define MVLIB_MEDIA_INVERSE_DEC_AUDIO_THREAD_IOS_BASE    (MVLIB_ERR_BASE + 0x58000)
#define MVLIB_MEDIA_PNG_ENCODE_BASE    (MVLIB_ERR_BASE + 0x58100)// encode_png.cpp
#endif
