...
#define MV2_CFG_PLAYER_SET_IGNORE_SKIP_MODE   (MV2_CFG_PLAYER_BASE + 31)
...
#define MV2_CFG_CUSTOM_PLAYER_3D_TRANSFORM            (MV2_CFG_CUSTOM_BASE + 112)
...
#define MV2_CFG_CUSTOM_PLAYER_TIME_MANAGER_CONTROL				(MV2_CFG_CUSTOM_BASE + 122)
